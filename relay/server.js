// FILE: server.js
// Purpose: Hosts the public Mobidex relay plus optional push-notification HTTP endpoints.
...
if (require.main === module) {
  ...
  const trustProxy = readOptionalBooleanEnv(["MOBIDEX_TRUST_PROXY", "REMODEX_TRUST_PROXY", "PHODEX_TRUST_PROXY"]) ?? false;
  const enablePushService = readOptionalBooleanEnv(
    ["MOBIDEX_ENABLE_PUSH_SERVICE", "REMODEX_ENABLE_PUSH_SERVICE", "PHODEX_ENABLE_PUSH_SERVICE"]
  ) ?? false;
