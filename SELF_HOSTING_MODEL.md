...
This file explains what the public Mobidex repository is for, what it includes, and what it does not include.

If you cloned Mobidex from GitHub, the intended path is local-first usage or self-hosting on infrastructure you control.
...
1. Local LAN pairing on your own machine with `./run-local-mobidex.sh`
2. A self-hosted relay on your own VPS, passed in through `MOBIDEX_RELAY`
...
- people can run Mobidex locally
...
If you fork or self-host Mobidex, keep these things out of the public repo:
...
If you cloned Mobidex from GitHub:

- do not expect a private hosted relay to be built in
- use `./run-local-mobidex.sh` for local testing
- use `MOBIDEX_RELAY` for your own VPS or hosted relay
