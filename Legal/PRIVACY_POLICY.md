# Mobidex — Data Protection Notice

**Last updated:** March 25, 2026

This Data Protection Notice explains how the Mobidex mobile application ("App"), developed by Ansar Ullah / Z360 ("Developer", "we", "us", or "our"), handles your information. Mobidex is designed to let you control a Codex runtime on your Mac from your iPhone. Most conversation and workspace activity is processed on your paired Mac, but private TestFlight or App Store builds can also use developer-operated relay infrastructure to connect your devices.

---

## 1. Overview

Mobidex is a local-first remote companion for Codex on your Mac. In practice, this means:
...
- Private TestFlight or App Store builds may use a developer-operated hosted relay to help your iPhone reach your paired Mac.
...
- **Voice recordings** — When you use voice mode, the App records a temporary WAV file on your iPhone and uploads that audio directly from the iPhone to OpenAI/ChatGPT for transcription. The request is authenticated with a ChatGPT token resolved from your paired Mac over the encrypted Mobidex channel.
...
We use the information above only to operate and secure Mobidex, including:
...
### 4.1 Developer-Operated Mobidex Infrastructure

Private TestFlight or App Store builds can use developer-operated infrastructure for:
...
Once the secure session is active, the hosted relay does **not** decrypt your Mobidex application payloads.
...
Because Mobidex is primarily local-first, much of your data remains under your direct control on your devices. We do not maintain a centralized database of your personal data. Some data may be processed or retained by Apple, RevenueCat, and OpenAI according to their own operational needs and policies.
