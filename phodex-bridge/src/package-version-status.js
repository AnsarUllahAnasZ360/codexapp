...
// Purpose: Reads the installed Mobidex package version and caches the latest published npm version.
// Layer: CLI helper
...
const MOBIDEX_REGISTRY_URL = "https://registry.npmjs.org/mobidex/latest";
...
function createBridgePackageVersionStatusReader({
  ...
  registryUrl = MOBIDEX_REGISTRY_URL,
