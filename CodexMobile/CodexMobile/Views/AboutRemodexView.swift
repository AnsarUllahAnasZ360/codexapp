    ...
    @ViewBuilder private var desktopSection: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            calloutCard(
                ...
                color: .blue,
                text: "The desktop app doesn't live-reload external writes. Use the desktop app handoff button in Mobidex to continue the current thread on your computer."
            )
        }
    }
