...
struct SidebarView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog(
            ...
            Text("Chats for this project will be deleted only from Mobidex on this phone. Nothing is removed from your computer or Codex observer.")
        }
        .alert(
            ...
            Text("This only removes the chat from Mobidex on this phone. Nothing is removed from your computer or Codex observer.")
        }
        .alert(
            "Action failed",
            isPresented: Binding(
