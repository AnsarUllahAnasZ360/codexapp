        ...
        VStack(alignment: .leading, spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 14) {
                if let command = prompt.command, !command.isEmpty {
                    ...
                    bridgeUpdateStep(number: "1", title: "Update Mobidex", detail: command, showsCopyButton: true)
                    bridgeUpdateStep(number: "2", title: "Start it again", detail: "Run mobidex up")
                    ...
                    bridgeUpdateStep(number: "1", title: "Update Mobidex", detail: "Install the latest Mobidex build on this iPhone.")
...
private extension CodexBridgeUpdatePrompt {
    static let previewScannerMismatch = CodexBridgeUpdatePrompt(
        title: "Update Mobidex on your Mac before scanning",
        message: "This QR code was generated by a different Mobidex npm version. Update the package on your Mac to the latest release before scanning a new QR code.",
